...
void _allocationBucketSerialize(
  ...
  writer.writeDouble(offsets[5], object.targetWeight);
...
AllocationBucket _allocationBucketDeserialize(
  ...
  object.targetWeight = reader.readDouble(offsets[5]);
...
extension AllocationBucketByIndex on IsarCollection<AllocationBucket> {
  Future<AllocationBucket?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  AllocationBucket? getByNameSync(String name) {
  ...
  Future<List<AllocationBucket?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<AllocationBucket?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(AllocationBucket object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(AllocationBucket object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<AllocationBucket> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<AllocationBucket> objects,
      {bool saveLinks = true}) {
...
extension AllocationBucketQueryWhereSort
  ...
  QueryBuilder<AllocationBucket, AllocationBucket, QAfterWhere> anyOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<AllocationBucket, AllocationBucket, QAfterWhere> anyIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension AllocationBucketQuerySortBy
  ...
  QueryBuilder<AllocationBucket, AllocationBucket, QAfterSortBy> sortByOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension AllocationBucketQuerySortThenBy
  ...
  QueryBuilder<AllocationBucket, AllocationBucket, QAfterSortBy> thenByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }
...
extension AllocationBucketQueryProperty
  ...
  QueryBuilder<AllocationBucket, String?, QQueryOperations> colorHexProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AllocationBucket, bool, QQueryOperations> isActiveProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AllocationBucket, int, QQueryOperations> orderProperty() {
    return QueryBuilder.apply(this, (query) {
